...
exports.run = async (bot, message, args, ops) => {
  ...
  if(!args[0]) return message.channel.send(`<:xcross:690880230562201610> Bruh you need to **sell** something`);
  let quantity;
  if(args[1] && isNaN(args[1])) return message.channel.send(`<:xcross:690880230562201610> urm the amount of items you're selling needs to be a number`);
  ...
  if(!items.index.includes(args[0].toLowerCase())) return message.channel.send(`<:xcross:690880230562201610> urm I don't think that item is even valid lol`);
  ...
  if(invUser.items[index] == 0) return message.channel.send(`<:xcross:690880230562201610> lol imagine selling something you don't have`);
  if(quantity > invUser.items[index]) return message.channel.send(`<:xcross:690880230562201610> Don't try to break me, you don't even have that much!`);
